...
#plot WMF for spread rate, creating Figure 3c 
png("results/Fig3c.png")
plotmag(wmf.spread)
abline(h=log2(4),lty=2)
dev.off()
#plot WMF for the four climate variables, creating Figure 4i-l 
png("results/Fig4i.png")
plotmag(wmf.tmean)
abline(h=log2(4),lty=2)
dev.off()
png("results/Fig4j.png")
plotmag(wmf.ppt)
abline(h=log2(4),lty=2)
dev.off()
png("results/Fig4k.png")
plotmag(wmf.tmin)
abline(h=log2(4),lty=2)
dev.off()
png("results/Fig4l.png")
...
#plot WPMF for spread rate, creating Figure 3h
