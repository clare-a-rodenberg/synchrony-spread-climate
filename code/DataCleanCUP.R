...
in.data.spread <- in.data.spread[, -c(1,2)]
...
in.data.tmean <- in.data.tmean[, -c(1,2)] 
...
in.data.tmin <- in.data.tmin[, -c(1,2)] 
...
in.data.snow_depth <- in.data.snow_depth[, -c(1,2)] 
