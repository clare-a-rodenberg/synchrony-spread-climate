...
in.data.t <- read.csv(here("data", "mwp_spread_climate.csv"), header = TRUE, sep = ",")
...
in.data.climate.indices <- read.csv(here("data", "clim.indices.mwp.spring.csv"), header = TRUE, sep = ",")
